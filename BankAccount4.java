...
public class BankAccount4 {
    ...
    public BankAccount4(String accountNumber,
                       double balance,
...
// Main.java (placed in the same file to avoid public conflict)
class Main {
    public static void main(String[] args) {
        // Create a BankAccount object using the no-argument constructor
        BankAccount newUserAccount = new BankAccount(); // prints "User created!"
        // Use the newUserAccount to avoid unused-variable warning
        System.out.println("Default account state: " + newUserAccount);
